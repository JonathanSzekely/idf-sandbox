// .ui.xml template last modified: 1550274550403
...
public class PersonViewImpl_PersonViewImplUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, com.candorgrc.idfusion.sandbox.client.view.impl.PersonViewImpl>, com.candorgrc.idfusion.sandbox.client.view.impl.PersonViewImpl.PersonViewImplUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    @Template("<header> <div class='filter-toolbar'> <div class='title form-field'> <span class='label'>Title</span> <select class='value'> <option value=''></option> <option value='Mr.'>Mr.</option> <option value='Mrs.'>Mrs.</option> <option value='Ms.'>Ms.</option> </select> </div> <div class='first-name form-field'> <span class='label'>First Name</span> <input class='value' type='text'> </div> <div class='last-name form-field'> <span class='label'>Last Name</span> <input class='value' type='text'> </div> <div class='suffix form-field'> <span class='label'>Suffix</span> <select class='value'> <option value=''></option> <option value='PhD'>PhD.</option> <option value='Engineer'>Engineer</option> <option value='Doctor'>Doctor</option> </select> </div> <div class='gender form-field'> <span class='label'>Gender</span> <select class='value'> <option value=''></option> <option value='m'>Male</option> <option value='f'>Female</option> </select> </div> <div class='race form-field'> <span class='label'>Race</span> <input class='value' type='text'> </div> <div class='language form-field'> <span class='label'>Language</span> <input class='value' type='text'> </div> <div class='university form-field'> <span class='label'>University</span> <input class='value' type='text'> </div> <div class='buzzword form-field'> <span class='label'>Buzzword</span> <input class='value' type='text'> </div> <div class='email form-field'> <span class='label'>E-Mail</span> <input class='value' type='text'> </div> <div class='job-title form-field'> <span class='label'>Job Title</span> <input class='value' type='text'> </div> <div class='linkedin-skill form-field'> <span class='label'>LinkedinIn Skill</span> <input class='value' type='text'> </div> <div class='company form-field'> <span class='label'>Company</span> <input class='value' type='text'> </div> <div class='dept form-field'> <span class='label'>Department</span> <input class='value' type='text'> </div> <div class='ein form-field'> <span class='label'>Employer Identification Number</span> <input class='value' type='text'> </div> <div class='form-field'> <label for='start'>Start</label> <input id='start' max='2018-12-31' min='2018-01-01' type='date' value='2018-09-29'> </div> <div class='form-field'> <label for='end'>End</label> <input id='end' max='2018-12-31' min='2018-01-01' type='date' value='2018-10-29'> </div> </div> <button class='apply-filters' id='{0}'>Apply Filters</button> </header> <section> <header class='controls'> <button class='toggle-view-mode' id='{1}'>Switch View Mode</button> <button class='reset' id='{2}'>Reset Data Collection</button> </header> <span id='{3}'></span>  <footer> <button class='fetch' id='{4}'>Fetch more...</button> </footer> </section>")
