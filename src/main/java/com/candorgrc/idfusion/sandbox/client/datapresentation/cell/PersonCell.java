		...
		@Template("<div class='person-cell'>"
				 	+ "<header>"
				 		+ "<figure>"
				 			...
				 			+ "</figcaption>"
				 		+ "</figure>"
						+ "<i class='contextual-menu fas fa-ellipsis-v'></i>"
					+ "</header>"
					+ "<section>"
						+ "<div class='personal-info'>"
							+ "<div class='section-title'><i class='fas'></i><span>Personal</span></div>"
							+ "<i class='{4}' title='{4}'></i>"
							+ "<div class='race' title='Race'>{5}</div>"
							+ "<div class='language' title='Language'>{6}</div>"
						+ "</div>"
						+ "<div class='education'>"
							+ "<div class='section-title'><i class='fas'></i><span>Education</span></div>"
							+ "<div class='university' title='University'>{7}</div>"
						+ "</div>"
						+ "<div class='work'>"
							+ "<div class='section-title'><i class='fas'></i><span>Work</span></div>"
					...
					+ "<footer>"
						+ "<nav class='controls'>"
							+ "<button class='edit' action='{16}' title='Edit'><i class='edit far fa-edit' action='{16}'></i><span>Edit</span></button>"
							+ "<button class='copy' action='{17}' title='Copy'><i class='copy far fa-copy' action='{17}'></i><span>Copy</span></button>"
							+ "<button class='delete' action='{18}' title='Delete'><i class='delete far fa-trash-alt' action='{18}'></i><span>Delete</span></button>"
						+ "</nav>"
					+ "</footer>"
				+ "</div>")
		//@formatter:on
